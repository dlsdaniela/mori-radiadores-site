<div class="container">
   <div class="content">
      <div class="benefits-home">
         <div class="benefits-home-image">
            <img src="assets/benefits.png" width="100%" alt="Beneficios Mori radiadores">
         </div>
         <div class="benefits-home-information">
            <div class="title">
               <h3>Veja alguma das <span>vantagens</span> de realizar o serviço com a gente!</h3>
            </div>
            ...
            <div class="benefits-home-information-card">
               ...
               <div class="card mb-3" style="max-width: 540px;">
                  <div class="row g-0">
                     <div class="col-md-4">
                        <img src="assets/benefits-qualidade.jpg" class="img-fluid" alt="..." width="100%">
                     </div>
                     <div class="col-md-8">
                        <div class="card-body">
               ...
               <div class="card mb-3" style="max-width: 540px;">
                  <div class="row g-0">
                     <div class="col-md-4">
                        <img src="assets/benefits-responsabilidade.jpg" class="img-fluid" alt="..." width="100%">
                     </div>
                     <div class="col-md-8">
                        <div class="card-body">
